...
| Understand which modules are deployable in an environment | [RB-00-02-modular-deployment-manifests.md](RB-00-02-modular-deployment-manifests.md) | PRD modularity docs in `PLANNING/` |
